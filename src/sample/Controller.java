...
public class Controller {
    ...
    public void updateTable(sample.classes.Queue q, ArrayList<Process> a)
    {
    ...
    protected void stopBTN_Click()
    {
        ...
        sample.classes.MemScheduler.clearMem();
        sample.classes.ClockGenerator.clearTime();
        Main.emuThread = new Thread(new sample.classes.TLauncher());
